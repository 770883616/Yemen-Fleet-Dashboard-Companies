                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('drivers.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="driver_name" type="text" class="form-control @error('driver_name') is-invalid @enderror" name="driver_name" value="{{ old('driver_name') }}" required autocomplete="name" autofocus>
                                @error('driver_name')
